...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Management /</span> Atikel</h4>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            if ($row['uploaded_at'] == '0000-00-00 00:00:00') {
                                                echo date('d M Y H:i:s', strtotime($row['created_at']));
                                            } else {
                                                echo date('d M Y H:i:s', strtotime($row['uploaded_at']));
                                            }
                                            ?>
                                        </td>
                                        <td>
                                            <a href="edit.php?id=<?= $row['id_artikel'] ?>" class="btn btn-sm btn-warning">Ubah</a>
                                            <a href="proses_aksi.php?id=<?= $row['id_artikel'] ?>&aksi=delete" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda ingin menghapus?');">Hapus</a>
                                        </td>
                                    </tr>
                            <?php }
                            } ?>
