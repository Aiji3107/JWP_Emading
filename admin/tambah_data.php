                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="judul_artikel" class="form-control" id="exampleFormControlInput1" placeholder="Judul Artikel" />
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Judul Artikel</label>
                                    <textarea class="form-control summernote" name="isi_artikel" id="exampleFormControlTextarea1" cols="30" rows="10" required></textarea>
                                </div>
                            </div>
                            <div class="col-lg-3">
